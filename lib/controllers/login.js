...
module.exports = function(user, publicKey, ws) {
  ...
  function loginSecrets(loginId, callback) {}
  function delLoginSecret(loginId, secretId) {}
  function createLoginSecret(loginId, secretData, callback)
  function updateLoginSecret(loginId, secretData, callback)
  ...
  return {
    ...
    put: put,
    del: del,
    loginSecrets: loginSecrets,
    delLoginSecret: delLoginSecret,
    createLoginSecret: createLoginSecret,
    updateLoginSecret: updateLoginSecret
  }
}
